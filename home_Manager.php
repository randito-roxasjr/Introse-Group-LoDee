			  ...
			  <div class="card text-white p-5" style="background-color: #087830">
				<div class="card-body">
				  ...
				  <hr class="w3-border-grey" style="margin:auto;width:60%">
					<center>
						<br>
						<a id="agents" class="btn text-white" href="agents.php" style="font-size: 20px"><i class="fa fa-user-secret" style="font-size: 30px"></i> Agents</a>
						<br>
						<a id="approvedClients" class="btn text-white" href="approvedClients.php" style="font-size: 20px"><i class="fa d-inline fa-lg fa-user-o"></i> Approved Clients</a>
					</center>
				</div>
			  </div>
			</div>
