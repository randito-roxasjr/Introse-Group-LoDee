                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                  <form method = "POST">
                                    ...
                                    <input onclick="location.href='insuranceCost.php?clientId=<?php echo $client_data['clientId']; ?>&notifId=<?php echo $v['notifId']?>'" type="submit" class="btn btn-success" value="Confirm" data-dismiss="modal"/>
                                  </form>
