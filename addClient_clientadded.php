...
<body>
  ...
  <div class="w3-animate-opacity">
	...
	if(isset($_POST['submit'])){
		...
		mysqli_stmt_bind_param($stmt1,"sssssssss", $first_name,$last_name, $house_address,$house_address2,$client_province,$client_city,$client_postalcode,$phone_number1,$phone_number2);
		...
		mysqli_stmt_bind_param($stmt1,"sssssis", $employee_login,$first_name,$last_name, $house_address,$client_province,$client_city,$client_postalcode, $phone_number);
